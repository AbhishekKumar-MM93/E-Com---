...
export const USER_GET_BY_ADMIN_REQUEST = "USER_GET_BY_ADMIN_REQUEST";
export const USER_GET_BY_ADMIN_SUCCESS = "USER_GET_BY_ADMIN_SUCCESS ";
export const USER_GET_BY_ADMIN_FAILURE = "USER_GET_BY_ADMIN_FAILURE ";
export const USER_GET_BY_ADMIN_RESET = "USER_GET_BY_ADMIN_RESET ";
...
export const USER_UPDATE_BY_ADMIN_FAILURE = "USER_UPDATE_BY_ADMIN_FAILURE";
